    ...
    <>
      ...
      <div className="max-w-3xl w-full">
        ...
        <div className={`mt-10 backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 text-center transition-all duration-800 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          <p className="text-white mb-3 text-xl font-semibold" style={{ textShadow: '1px 1px 4px rgba(0, 0, 0, 0.8)' }}>
            Feeling called out?
          </p>
          <p className="text-white mb-4 text-xl font-semibold" style={{ textShadow: '1px 1px 4px rgba(0, 0, 0, 0.8)' }}>
            Mind blown and thinking, "ok now what?"
          </p>
          <p className="text-white mb-6 text-lg" style={{ textShadow: '1px 1px 4px rgba(0, 0, 0, 0.8)' }}>
            Click the button below to turn this wound into wisdom!
          </p>
          <div className="flex justify-center mb-6">
            <a
              ...
              className="inline-flex items-center gap-2 font-bold text-white px-10 py-4 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 text-xl uppercase tracking-wider"
              style={{ backgroundColor: '#3c7a6e' }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#2f6156'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#3c7a6e'}
            >
              Wound to Wisdom
            </a>
          </div>
          <p className="text-white mb-2 text-base" style={{ textShadow: '1px 1px 4px rgba(0, 0, 0, 0.8)' }}>
            You've got mail! This report will be emailed to you in PDF so you can keep it forever.
          </p>
          <p className="text-white text-base" style={{ textShadow: '1px 1px 4px rgba(0, 0, 0, 0.8)' }}>
            Questions? Email me at <a href="mailto:magic@lovelightandblackholes.com" className="underline hover:text-white/90">magic@lovelightandblackholes.com</a>
          </p>
        </div>
      </div>
    </div>
